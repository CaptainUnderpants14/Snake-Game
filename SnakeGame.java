...
import java.util.Random;//to generate random food block
...
public class SnakeGame extends JPanel implements ActionListener, KeyListener{
    ...
    public void move(){
        ...
        if (snakeHead.x*tileSize < 0 || snakeHead.x*tileSize > frameWidth || //passed left border or right border
            snakeHead.y*tileSize < 0 || snakeHead.y*tileSize > frameHeight ) { //passed top border or bottom border
            gameOver = true;
        }
    }
